<?php
/**
 * beans functions and definitions
 *
 * @package beans
 */
...
function beans_setup() {\
	 ...
	 * If you're building a theme based on beans, use a find and replace
	...
	add_theme_support( 'custom-background', apply_filters( 'beans_custom_background_args', array(
...
add_action( 'after_setup_theme', 'beans_setup' );
...
function beans_scripts() {
	wp_enqueue_style( 'beans-style', get_stylesheet_uri() );

	wp_enqueue_script( 'beans-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
